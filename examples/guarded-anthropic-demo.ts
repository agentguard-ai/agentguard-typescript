 ...
 * TealAnthropic Demo
 * 
 * Demonstrates how to use TealAnthropic as a drop-in replacement
...
async function main() {
  console.log('=== TealAnthropic Demo ===\n');
  ...
  // 3. Create TealAnthropic client
  console.log('3. Creating TealAnthropic client...');
  ...
  // 5. Try a request with system prompt
  console.log('5. Testing with system prompt...');
  try {
    const response = await client.messages.create({
      model: 'claude-3-sonnet-20240229',
      max_tokens: 100,
  ...
  // 8. Test array content format
  console.log('8. Testing array content format...');
  try {
    const response = await client.messages.create({
      model: 'claude-3-sonnet-20240229',
      max_tokens: 100,
    ...
    console.log('✓ Array content format works');
    console.log('Response:', response.content[0].text);
    console.log();
  } catch (error) {
    console.error('✗ Request failed:', error);
